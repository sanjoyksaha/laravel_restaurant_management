            ...
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">
                        <img id="logo" src="{{ asset('frontend/images/logo.jpg') }}" class="logo img-responsive img-thumbnail">
                    </a>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="section-header">
                                        <h2 class="pricing-title">Our Food Menu Items In Affordable Pricing</h2>
                                        <ul id="filter-list" class="clearfix">
                                            <li class="filter" data-filter="all">All</li>
                                            @foreach( $categories as $category )
                                                <li class="filter" data-filter="#{{ $category->slug}}">{{ $category->category_name }} <span class="badge">{{ $category->items->count() }}</span></li>
                                            @endforeach
                                        </ul><!-- @end #filter-list -->
                                    </div>
                                </div>
                            ...
                            <ul id="menu-pricing" class="menu-price">
                                @foreach( $items as $item )
                                    <li class="item" id="{{ $item->category->slug }}">
                                        ...
                                        <a href="#">
                                            <img src="{{ asset('uploads/items/'.$item->image)}}" class="img-responsive img-thumbnail" alt="Food" style="width: 500px; height: 200px;" >
                    ...
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                ...
                                </script> Developed By <a href="https://www.facebook.com/sahaksanjoy" target="_blank"> Sanjoy Kumar Saha</a>
                            </p>
                        </div>
                    </div>
                </div>
